...
export const GAMES_DATA: Game[] = [
  {
    ...
    title: 'Summit Spark',
    chineseTitle: '山巅微光',
    chineseTitleTraditional: '山巔微光',
    category: '平台动作',
    categoryEn: 'Platformer',
    difficulty: 5,
    description: '原创高精度平台跳跃游戏原型。包含跳跃、冲刺、攀墙等高精度操作，提供房间 PB 计时、最佳路线幽灵追逐及多项动作手感校准。',
    descriptionTraditional: '原創高精度平台跳躍遊戲原型。包含跳躍、衝刺、攀牆等高精度操作，提供房間 PB 計時、最佳路線幽靈追逐及多項動作手感校準。',
  ...
  },
  {
    ...
    chineseTitle: '云深处',
    chineseTitleTraditional: '雲深處',
    category: '叙事探索',
    categoryEn: 'Narrative',
    difficulty: 2,
    description: '可交互的空中城市观察台。扫描隐藏频段、锁定异常信号，沿全局线索推进调查，解密云端之上的市民生活与浮空城之谜。',
    descriptionTraditional: '可互動的空中城市觀察台。掃描隱藏頻段、鎖定異常訊號，沿全域線索推進調查，解密雲端之上的市民生活與浮空城之謎。',
  ...
  },
  {
    ...
    chineseTitle: '星野方舟',
    chineseTitleTraditional: '星野方舟',
    category: '沙盒建造',
    categoryEn: 'Sandbox',
    difficulty: 3,
    description: '第一人称 3D 体素浮岛探索与建造沙盒。采集和放置方块以建设属于你的星野方舟，收集界碑碎片，体验柔和日夜循环与水面星光粒子。',
    descriptionTraditional: '第一人稱 3D 體素浮島探索與建造沙盒。採集和放置方塊以建設屬於你的星野方舟，收集界碑碎片，體驗柔和日夜循環與水面星光粒子。',
  ...
  },
  {
    ...
    title: 'sudoku',
    chineseTitle: '数独',
    chineseTitleTraditional: '數獨',
    category: '经典解谜',
    categoryEn: 'Puzzle',
    difficulty: 2,
    description: '专业级数独解谜平台。支持经典 9x9、锯齿数独（不规则宫）、对角线数独三种模式，提供位解密求解、无限撤销及历史存档。',
    descriptionTraditional: '專業級數獨解謎平台。支援經典 9x9、鋸齒數獨（不規則宮）、對角線數獨三種模式，提供位元遮罩求解、無限復原及歷史存檔。',
  ...
  },
  {
    ...
    title: 'minesweeper',
    chineseTitle: '扫雷',
    chineseTitleTraditional: '掃雷',
    category: '经典解谜',
    categoryEn: 'Puzzle',
    difficulty: 2,
    description: '工业级高帧率扫雷体验。采用零拷贝 BFS 级联翻开算法及 Fisher-Yates 随机置乱雷区，支持双击快速排雷及首击绝对安全保证。',
    descriptionTraditional: '工業級高幀率掃雷體驗。採用零拷貝 BFS 級聯翻開演算法及 Fisher-Yates 隨機置亂雷區，支援雙擊快速排雷及首擊絕對安全保證。',
  ...
  },
  {
    ...
    title: 'crateveil',
    chineseTitle: '推箱子',
    chineseTitleTraditional: '推箱子',
    category: '经典解谜',
    categoryEn: 'Puzzle',
    difficulty: 3,
    description: '复古未来主义终端推箱子游戏。推动箱子，显现迷宫，连接终端。拥有霓虹 CRT 显像管滤镜与纯代码生成的复古电子音效。',
    descriptionTraditional: '復古未來主義終端推箱子遊戲。推動箱子，顯現迷宮，連接終端。擁有霓虹 CRT 顯像管濾鏡與純程式碼生成的復古電子音效。',
  ...
  },
  {
    ...
    descriptionTraditional: '精緻的網頁版 2048。保留經典數字合併規則，並加入 4×4、5×5、6×6 棋盤、主題切換、音效預設、復原、統計、成就與行動裝置適配。',
  ...
  },
  {
    ...
    title: 'Last Archive',
    chineseTitle: '最后档案城',
    chineseTitleTraditional: '最後檔案城',
    category: '经营模拟',
    categoryEn: 'Simulation',
    difficulty: 4,
    description: '末世避难所经营与 AI 叙事沙盒。在灾难后的废墟中建设城镇、分派工作、平息危机，并在残存的人类记忆中进行抉择，引导人类文明走向不同的终局。',
    descriptionTraditional: '末世避難所經營與 AI 敘事沙盒。在災難後的廢墟中建設城鎮、分派工作、平息危機，並在殘存的人類記憶中進行抉擇，引導人類文明走向不同的終局。',
  ...
  },
  {
    ...
    title: 'Praesidium',
    chineseTitle: '守望',
    chineseTitleTraditional: '守望',
    category: '策略塔防',
    categoryEn: 'Tower Defense',
    difficulty: 4,
    description: '高完成度科幻塔防网页游戏。包含 6 个主题战役关卡、无尽与每日挑战、种子分享、情报图鉴、波次威胁预告、天赋树、成就、统计、移动端触控优化与发布级验证流程。',
    descriptionTraditional: '高完成度科幻塔防網頁遊戲。包含 6 個主題戰役關卡、無盡與每日挑戰、種子分享、情報圖鑑、波次威脅預告、天賦樹、成就、統計、行動裝置觸控最佳化與發佈級驗證流程。',
  ...
  },
  {
    ...
    chineseTitle: '永恒帝国',
    chineseTitleTraditional: '永恆帝國',
    category: '策略模拟',
    categoryEn: 'Strategy Sim',
    difficulty: 5,
    description: '以国家治理为核心的历史策略模拟游戏。在财政、粮食、人口、法律、派系、战争、外交、科技、地方治理与长期稳定之间做取舍，建立能长期运转的国家机器。',
    descriptionTraditional: '以國家治理為核心的歷史策略模擬遊戲。在財政、糧食、人口、法律、派系、戰爭、外交、科技、地方治理與長期穩定之間做取捨，建立能長期運轉的國家機器。',
  ...
  },
  {
    ...
    chineseTitle: '狮城秘语',
    chineseTitleTraditional: '獅城秘語',
    category: '叙事探索',
    categoryEn: 'Narrative',
    difficulty: 3,
    description: '沉浸式叙事解谜游戏。穿梭于新加坡河畔与神秘灵界之间，寻找并修复四大古老文物，最终在博物馆展厅中完成你的策展展览。',
    descriptionTraditional: '沉浸式敘事解謎遊戲。穿梭於新加坡河畔與神祕靈界之間，尋找並修復四大古老文物，最終在博物館展廳中完成你的策展展覽。',
  ...
  },
  {
    ...
    chineseTitleTraditional: '語弦生態：斷句庭院灰盒原型',
    category: '语义解谜',
    categoryEn: 'Semantic Puzzle',
    difficulty: 3,
    description: '《语弦生态：创世纪》的可玩网页原型。通过扫描对象、剥离词缀、注入槽位，配合温度、介质与力场触发蒸汽爆发、破裂窗口等组合反应，挑战残章守卫。',
    descriptionTraditional: '《語弦生態：創世紀》的可玩網頁原型。透過掃描物件、剝離詞綴、注入槽位，配合溫度、介質與力場觸發蒸汽爆發、破裂窗口等組合反應，挑戰殘章守衛。',
  ...
  },
  {
    ...
    chineseTitleTraditional: 'Overlogic',
    category: '编程策略',
    categoryEn: 'Programming Strategy',
    difficulty: 4,
    description: '二维自走棋Roguelike策略游戏。通过编写“IF 条件 THEN 行动”规则库，为战斗机器人定制大脑，在分支路线和多变关卡中不断调试，优化规则序列。',
    descriptionTraditional: '二維自走棋 Roguelike 策略遊戲。透過編寫「IF 條件 THEN 行動」規則庫，為戰鬥機器人自訂大腦，在分支路線和多變關卡中不斷除錯，最佳化規則序列。',
...
const validateGameCatalog = (games: Game[]) => {
  ...
  games.forEach(game => {
    ...
    if (!game.title.trim()) throw new Error(`Missing title for game: ${game.id}`);
    if (!game.category.trim() || !game.categoryEn.trim()) throw new Error(`Missing category for game: ${game.id}`);
    if (!game.description.trim() || !game.descriptionTraditional.trim() || !game.descriptionEn.trim()) {
      throw new Error(`Missing localized description for game: ${game.id}`);
    }
    if (game.difficulty < 1 || game.difficulty > 5) throw new Error(`Invalid difficulty for game: ${game.id}`);
    if (!/^#[0-9a-f]{6}$/i.test(game.accentColor)) throw new Error(`Invalid accent color for game: ${game.id}`);
    if (game.status === 'playable' && !game.prodUrl.trim()) throw new Error(`Playable game has no production URL: ${game.id}`);

    try {
      if (game.prodUrl) new URL(game.prodUrl);
      new URL(game.devUrl);
    } catch {
      throw new Error(`Invalid URL for game: ${game.id}`);
    }
  });
};

validateGameCatalog(GAMES_DATA);
